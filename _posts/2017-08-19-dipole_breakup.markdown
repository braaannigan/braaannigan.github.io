...
A [github repository](https://github.com/braaannigan/subsurface_eddy_generation_arctic_fronts_brannigan_et_al_2017)
with the code used to generate the input files and run the model is also online.
